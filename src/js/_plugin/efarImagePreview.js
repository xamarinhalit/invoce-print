    ...
    $.extend({
        uploadPreview: function (options) {
            ...
            var settings = $.extend({
                ...
                preview_box: ".efar-image-preview",
                label_field: ".image-label",
                label_default: "<i class='fa fa-upload'></i> Yükle",
                label_selected: "<i class='fa fa-upload'></i> Yükle",
                imageSave: null,
                no_label: false,
                ...
                if (typeof ($(settings.input_field)) !== 'undefined' && $(settings.input_field) !== null) {
                    $(settings.input_field).change(function () {
                        ...
                        if (files.length > 0) {
                            ...
                            reader.addEventListener("load", function (event) {
                                ...
                                if (file.type.match('image')) {
                                    ...
                                    if (settings.imageSave) { 
                                        settings.imageSave(loadedFile.result);
                                    }
                            ...
                            if (settings.clear_callback) {
                                settings.clear_callback();
                            }
                            // Clear background
